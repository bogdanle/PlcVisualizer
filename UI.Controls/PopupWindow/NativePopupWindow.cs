...
namespace UI.Controls
{
    ...
    {
        public static readonly DependencyProperty LayoutRootMarginProperty = DependencyProperty.Register("LayoutRootMargin", typeof(Thickness), typeof(PopupWindow), new PropertyMetadata(new Thickness(0)));
