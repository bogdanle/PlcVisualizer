...
namespace UI.Controls
{
    ...
    public class CaptionButton : System.Windows.Controls.Button
    {
        public static readonly DependencyProperty ButtonTypeProperty =
            DependencyProperty.Register("ButtonType", typeof(CaptionButtonType), typeof(CaptionButton), new PropertyMetadata(CaptionButtonType.None, OnButtonTypePropertyChanged));
