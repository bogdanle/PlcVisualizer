...
{
    public static readonly DependencyProperty ProgressBarVisibilityProperty = DependencyProperty.Register(nameof(ProgressBarVisibility), typeof(Visibility), typeof(BusyIndicator), new PropertyMetadata(Visibility.Collapsed));
    public static readonly DependencyProperty ProgressBarValueProperty = DependencyProperty.Register(nameof(ProgressBarValue), typeof(int), typeof(BusyIndicator), new PropertyMetadata(-1, OnProgressBarValueChanged));
    public static readonly DependencyProperty PercentCompleteStringProperty = DependencyProperty.Register(nameof(PercentCompleteString), typeof(string), typeof(BusyIndicator), new PropertyMetadata(null));
    ...
    public static readonly DependencyProperty ProgressBarStyleProperty = DependencyProperty.Register(nameof(ProgressBarStyle), typeof(Style), typeof(BusyIndicator), new PropertyMetadata(null));
    ...
    public static readonly DependencyProperty DisplayAfterProperty = DependencyProperty.Register(nameof(DisplayAfter), typeof(TimeSpan), typeof(BusyIndicator), new PropertyMetadata(TimeSpan.FromSeconds(0.1)));
